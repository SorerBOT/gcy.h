...
CUNIT_TEST(test_single)
{
    ...
    char* ptr_1 = GCY_CALLOC(strlen(my_str), sizeof(char));
...
CUNIT_TEST(test_multiple)
{
    ...
    char* ptr_2 = GCY_CALLOC(strlen(my_str), sizeof(char));
    CUNIT_ASSERT_PTR_NOT_NULL(ptr_2);
    CUNIT_ASSERT_INT_EQ(gcy_debug_get_allocations_count(), 2);

    char* ptr_3 = GCY_CALLOC(strlen(my_str), sizeof(char));
...
CUNIT_TEST(free_in_different_order)
{
    ...
    char* ptr_2 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_3 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_4 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_5 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_6 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_7 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_8 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_9 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_10 = GCY_CALLOC(strlen(my_str), sizeof(char));
    char* ptr_11 = GCY_CALLOC(strlen(my_str), sizeof(char));
